...
<div class="screenContainer" id="screenContainer" style="background-color: lightskyblue; opacity: 0; transition: opacity 0.1s ease-out">
	<div class="screenVCenter">
		<div class="screenCenter">
		<img src="../assets/images/logo_arista.png" alt="ICEcoder">
		...
		?>
		<input type="password" name="password" class="password"  placeholder="Enter Admin Password"  id="password"<?php
            if (true === $settingPW) {
